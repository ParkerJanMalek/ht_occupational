...
all_feature_names = poly.get_feature_names_out(opera_cols)
opera_cols_ints = all_feature_names[len(opera_cols):]  # Slice to exclude original features


# = poly.get_feature_names()[len(opera_cols):]
opera_cols_ints_names = opera_cols_ints#poly.get_feature_names(opera_cols)[len(opera_cols):]
