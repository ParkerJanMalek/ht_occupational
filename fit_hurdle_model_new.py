...
with open(model_part_1_file, 'wb') as f:
    cloudpickle.dump(fit1, f)
#az.to_netcdf(idata, "output/model_part1.nc")
...
with open(model_part_2_file, 'wb') as f:
    cloudpickle.dump(fit2, f)
...
posterior_trace = fit1.approx.sample(1000)  # or 5000 if preferred
